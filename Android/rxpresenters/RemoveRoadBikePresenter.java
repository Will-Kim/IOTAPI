...
public class RemoveRoadBikePresenter {
    private RegisterBike mRegisterBike;
    private HKRiderService mRiderService;
    private String TAG = "RemoveRoadBikePresenter";

    public RemoveRoadBikePresenter(RegisterBike RegisterBikeActivity) {
        mRegisterBike = RegisterBikeActivity;
        mRiderService = new HKRiderService();
    }

    public void RemoveRoadBike(final PostRoadBike postRoadBike) {

        postRoadBike.header.action = "RemoveRoadBike";
        Call<ResponseUserInfo> call = mRiderService.getAPIs().postRemoveRoadBike(postRoadBike);
        ...
        call.enqueue(new Callback<ResponseUserInfo>() {
            ...
            public void onResponse(Call<ResponseUserInfo> call, Response<ResponseUserInfo> response) {
                ...
                if(response.body().header.result_code != 0) { // Custom 오류 처리.
                    mRegisterBike.onRemoveRoadBikeError(response.body().header.message);
//                    Commons.showToast(mRegisterBike, response.body().header.message);
                    ...
                    mRegisterBike.onRemoveRoadBikeSuccess();
                }
            ...
            public void onFailure(Call<ResponseUserInfo> call, Throwable t) {
                ...
                mRegisterBike.onRemoveRoadBikeFail();
